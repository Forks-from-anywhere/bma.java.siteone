...
import bma.siteone.clound.common.CloundApi4RuntimeConfig.REQ;
import bma.siteone.clound.local.SimpleLocalCloundApi;

public class CloundApi4RuntimeConfig extends SimpleLocalCloundApi<REQ, String> {

	final org.slf4j.Logger log = org.slf4j.LoggerFactory
			.getLogger(CloundApi4RuntimeConfig.class);
	...
	public CloundApi4RuntimeConfig() {
		super();
