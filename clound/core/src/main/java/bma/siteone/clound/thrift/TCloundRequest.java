...
public class TCloundRequest implements org.apache.thrift.TBase<TCloundRequest, TCloundRequest._Fields>, java.io.Serializable, Cloneable {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("TCloundRequest");
  ...
  static {
    schemes.put(StandardScheme.class, new TCloundRequestStandardSchemeFactory());
    schemes.put(TupleScheme.class, new TCloundRequestTupleSchemeFactory());
  }

  public TCloundEntry entry; // required
  public String content; // required
  public TCloundEntry callback; // required
  public boolean logtrack; // required
  public TCloundEntry referer; // required
  ...
  static {
    ...
    tmpMap.put(_Fields.ENTRY, new org.apache.thrift.meta_data.FieldMetaData("entry", org.apache.thrift.TFieldRequirementType.DEFAULT, 
        new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, TCloundEntry.class)));
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(TCloundRequest.class, metaDataMap);
  }

  public TCloundRequest() {
  }

  public TCloundRequest(
    TCloundEntry entry,
    String content,
    TCloundEntry callback,
    boolean logtrack,
    TCloundEntry referer)
  {
    this();
    this.entry = entry;
   ...
   */
  public TCloundRequest(TCloundRequest other) {
    __isset_bit_vector.clear();
    __isset_bit_vector.or(other.__isset_bit_vector);
    if (other.isSetEntry()) {
      this.entry = new TCloundEntry(other.entry);
    }
    if (other.isSetContent()) {
      this.content = other.content;
    }
    if (other.isSetCallback()) {
      this.callback = new TCloundEntry(other.callback);
    }
    this.logtrack = other.logtrack;
    if (other.isSetReferer()) {
      this.referer = new TCloundEntry(other.referer);
    }
  }

  public TCloundRequest deepCopy() {
    return new TCloundRequest(this);
  }
  ...
  public TCloundEntry getEntry() {
    return this.entry;
  }

  public TCloundRequest setEntry(TCloundEntry entry) {
    this.entry = entry;
    return this;
  }
  ...
  public TCloundRequest setContent(String content) {
    this.content = content;
    return this;
  }
  ...
  public TCloundEntry getCallback() {
    return this.callback;
  }

  public TCloundRequest setCallback(TCloundEntry callback) {
    this.callback = callback;
    return this;
  }
  ...
  public TCloundRequest setLogtrack(boolean logtrack) {
    this.logtrack = logtrack;
    setLogtrackIsSet(true);
    return this;
  }
  ...
  public TCloundEntry getReferer() {
    return this.referer;
  }

  public TCloundRequest setReferer(TCloundEntry referer) {
    this.referer = referer;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case CALLBACK:
      if (value == null) {
        ...
        setCallback((TCloundEntry)value);
      }
      break;
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof TCloundRequest)
      return this.equals((TCloundRequest)that);
    return false;
  }

  public boolean equals(TCloundRequest that) {
    if (that == null)
      return false;
  ...
  public int compareTo(TCloundRequest other) {
    if (!getClass().equals(other.getClass())) {
      return getClass().getName().compareTo(other.getClass().getName());
    }

    int lastComparison = 0;
    TCloundRequest typedOther = (TCloundRequest)other;
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("TCloundRequest(");
    boolean first = true;
  ...
  private static class TCloundRequestStandardSchemeFactory implements SchemeFactory {
    public TCloundRequestStandardScheme getScheme() {
      return new TCloundRequestStandardScheme();
    }
  }

  private static class TCloundRequestStandardScheme extends StandardScheme<TCloundRequest> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, TCloundRequest struct) throws org.apache.thrift.TException {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
          ...
          case 3: // CALLBACK
            if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
              struct.callback = new TCloundEntry();
          ...
          case 5: // REFERER
            if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
              struct.referer = new TCloundEntry();
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TCloundRequest struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class TCloundRequestTupleSchemeFactory implements SchemeFactory {
    public TCloundRequestTupleScheme getScheme() {
      return new TCloundRequestTupleScheme();
    }
  }

  private static class TCloundRequestTupleScheme extends TupleScheme<TCloundRequest> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, TCloundRequest struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, TCloundRequest struct) throws org.apache.thrift.TException {
