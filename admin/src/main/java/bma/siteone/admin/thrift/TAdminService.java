              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.success = new ArrayList<TRole>(_list8.size);
                  for (int _i9 = 0; _i9 < _list8.size; ++_i9)
                  {
                    TRole _elem10; // required
                    _elem10 = new TRole();
                    _elem10.read(iprot);
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, queryRoles_result struct) throws org.apache.thrift.TException {
        ...
        if (struct.success != null) {
          oprot.writeFieldBegin(SUCCESS_FIELD_DESC);
          {
            ...
            for (TRole _iter11 : struct.success)
            {
              _iter11.write(oprot);
            }
            oprot.writeListEnd();
        ...
        if (struct.isSetSuccess()) {
          {
            ...
            for (TRole _iter12 : struct.success)
            {
              _iter12.write(oprot);
            }
          }
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.success = new ArrayList<TRole>(_list13.size);
            for (int _i14 = 0; _i14 < _list13.size; ++_i14)
            {
              TRole _elem15; // required
              _elem15 = new TRole();
              _elem15.read(iprot);
