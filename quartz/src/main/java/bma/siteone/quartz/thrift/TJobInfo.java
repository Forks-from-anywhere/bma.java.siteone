...
public class TJobInfo implements org.apache.thrift.TBase<TJobInfo, TJobInfo._Fields>, java.io.Serializable, Cloneable {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("TJobInfo");
  ...
  private static final org.apache.thrift.protocol.TField DISALLOW_CONCURRENT_FIELD_DESC = new org.apache.thrift.protocol.TField("disallowConcurrent", org.apache.thrift.protocol.TType.BOOL, (short)5);
  private static final org.apache.thrift.protocol.TField PERSIST_AFTER_EXECUTION_FIELD_DESC = new org.apache.thrift.protocol.TField("persistAfterExecution", org.apache.thrift.protocol.TType.BOOL, (short)6);
  private static final org.apache.thrift.protocol.TField JOB_DATAS_FIELD_DESC = new org.apache.thrift.protocol.TField("jobDatas", org.apache.thrift.protocol.TType.MAP, (short)7);

  private static final Map<Class<? extends IScheme>, SchemeFactory> schemes = new HashMap<Class<? extends IScheme>, SchemeFactory>();
  static {
    schemes.put(StandardScheme.class, new TJobInfoStandardSchemeFactory());
    schemes.put(TupleScheme.class, new TJobInfoTupleSchemeFactory());
  }
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    ...
    DISALLOW_CONCURRENT((short)5, "disallowConcurrent"),
    PERSIST_AFTER_EXECUTION((short)6, "persistAfterExecution"),
    JOB_DATAS((short)7, "jobDatas");
    ...
    public static _Fields findByThriftId(int fieldId) {
      switch(fieldId) {
        ...
        case 4: // DURABILITY
          return DURABILITY;
        case 5: // DISALLOW_CONCURRENT
          return DISALLOW_CONCURRENT;
        case 6: // PERSIST_AFTER_EXECUTION
  ...
  private static final int __DISALLOWCONCURRENT_ISSET_ID = 1;
  private static final int __PERSISTAFTEREXECUTION_ISSET_ID = 2;
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(TJobInfo.class, metaDataMap);
  }
   ...
   */
  public TJobInfo(TJobInfo other) {
  ...
  @Override
public TJobInfo deepCopy() {
    return new TJobInfo(this);
  }
  ...
  public TJobInfo setType(String type) {
    this.type = type;
    return this;
  }
  ...
  public TJobInfo setName(String name) {
    this.name = name;
    return this;
  }
  ...
  public TJobInfo setGroup(String group) {
    this.group = group;
    return this;
  }
  ...
  public TJobInfo setDurability(boolean durability) {
    this.durability = durability;
    setDurabilityIsSet(true);
    return this;
  }
  ...
  public TJobInfo setDisallowConcurrent(boolean disallowConcurrent) {
    this.disallowConcurrent = disallowConcurrent;
    setDisallowConcurrentIsSet(true);
    return this;
  }
  ...
  public TJobInfo setPersistAfterExecution(boolean persistAfterExecution) {
    this.persistAfterExecution = persistAfterExecution;
    setPersistAfterExecutionIsSet(true);
    return this;
  }
  ...
  public TJobInfo setJobDatas(Map<String,String> jobDatas) {
    this.jobDatas = jobDatas;
    return this;
  }
...
public boolean isSet(_Fields field) {
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof TJobInfo)
      return this.equals((TJobInfo)that);
    return false;
  }

  public boolean equals(TJobInfo that) {
    if (that == null)
      return false;
  ...
  @Override
public int compareTo(TJobInfo other) {
    if (!getClass().equals(other.getClass())) {
      return getClass().getName().compareTo(other.getClass().getName());
    }

    int lastComparison = 0;
    TJobInfo typedOther = other;
...
public void write(org.apache.thrift.protocol.TProtocol oprot) throws org.apache.thrift.TException {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("TJobInfo(");
    boolean first = true;
  ...
  private static class TJobInfoStandardSchemeFactory implements SchemeFactory {
    @Override
	public TJobInfoStandardScheme getScheme() {
      return new TJobInfoStandardScheme();
    }
  }

  private static class TJobInfoStandardScheme extends StandardScheme<TJobInfo> {

    @Override
	public void read(org.apache.thrift.protocol.TProtocol iprot, TJobInfo struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.jobDatas = new HashMap<String,String>(2*_map10.size);
                for (int _i11 = 0; _i11 < _map10.size; ++_i11)
                {
                  ...
                  struct.jobDatas.put(_key12, _val13);
                }
                iprot.readMapEnd();
              }
    ...
    @Override
	public void write(org.apache.thrift.protocol.TProtocol oprot, TJobInfo struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.jobDatas != null) {
        oprot.writeFieldBegin(JOB_DATAS_FIELD_DESC);
        {
          ...
          for (Map.Entry<String, String> _iter14 : struct.jobDatas.entrySet())
          {
  ...
  private static class TJobInfoTupleSchemeFactory implements SchemeFactory {
    @Override
	public TJobInfoTupleScheme getScheme() {
      return new TJobInfoTupleScheme();
    }
  }

  private static class TJobInfoTupleScheme extends TupleScheme<TJobInfo> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, TJobInfo struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetJobDatas()) {
        {
          ...
          for (Map.Entry<String, String> _iter15 : struct.jobDatas.entrySet())
          {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, TJobInfo struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(6)) {
        {
          ...
          struct.jobDatas = new HashMap<String,String>(2*_map16.size);
          for (int _i17 = 0; _i17 < _map16.size; ++_i17)
          {
            ...
            struct.jobDatas.put(_key18, _val19);
          }
        }
        struct.setJobDatasIsSet(true);
      }
