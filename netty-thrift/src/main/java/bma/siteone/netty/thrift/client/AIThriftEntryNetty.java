...
import bma.common.thrift.entry.ThriftEntrySimple;

public class AIThriftEntryNetty implements AIThriftEntry {

	final org.slf4j.Logger log = org.slf4j.LoggerFactory
			.getLogger(AIThriftEntryNetty.class);
	...
	public AIThriftClientFactory createAIFactory(String entry) {
		...
		if (!ThriftEntrySimple.buildConfig(entry, fac)) {
