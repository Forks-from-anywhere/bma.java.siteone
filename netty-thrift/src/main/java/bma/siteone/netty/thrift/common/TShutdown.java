...
public class TShutdown {
  ...
  public interface Iface {
    ...
    public void shutdown(String confirmWord) throws org.apache.thrift.TException;

  }

  public interface AsyncIface {

    public void shutdown(String confirmWord, org.apache.thrift.async.AsyncMethodCallback<AsyncClient.shutdown_call> resultHandler) throws org.apache.thrift.TException;
  ...
  public static class Client extends org.apache.thrift.TServiceClient implements Iface {
    ...
    public void shutdown(String confirmWord) throws org.apache.thrift.TException
    {
      send_shutdown(confirmWord);
      recv_shutdown();
    }

    public void send_shutdown(String confirmWord) throws org.apache.thrift.TException
    {
      shutdown_args args = new shutdown_args();
      args.setConfirmWord(confirmWord);
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public void shutdown(String confirmWord, org.apache.thrift.async.AsyncMethodCallback<shutdown_call> resultHandler) throws org.apache.thrift.TException {
      checkReady();
      shutdown_call method_call = new shutdown_call(confirmWord, resultHandler, this, ___protocolFactory, ___transport);
    ...
    public static class shutdown_call extends org.apache.thrift.async.TAsyncMethodCall {
      ...
      public shutdown_call(String confirmWord, org.apache.thrift.async.AsyncMethodCallback<shutdown_call> resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
  ...
  public static class Processor<I extends Iface> extends org.apache.thrift.TBaseProcessor<I> implements org.apache.thrift.TProcessor {
    ...
    private static class shutdown<I extends Iface> extends org.apache.thrift.ProcessFunction<I, shutdown_args> {
      ...
      protected shutdown_result getResult(I iface, shutdown_args args) throws org.apache.thrift.TException {
        shutdown_result result = new shutdown_result();
        iface.shutdown(args.confirmWord);
        return result;
      }
    }
  ...
  public static class shutdown_args implements org.apache.thrift.TBase<shutdown_args, shutdown_args._Fields>, java.io.Serializable, Cloneable   {
    ...
    private static final org.apache.thrift.protocol.TField CONFIRM_WORD_FIELD_DESC = new org.apache.thrift.protocol.TField("confirmWord", org.apache.thrift.protocol.TType.STRING, (short)1);
    ...
    public String confirmWord; // required

    /** The set of fields this struct contains, along with convenience methods for finding and manipulating them. */
    public enum _Fields implements org.apache.thrift.TFieldIdEnum {
      CONFIRM_WORD((short)1, "confirmWord");
    ...
    static {
      ...
      tmpMap.put(_Fields.CONFIRM_WORD, new org.apache.thrift.meta_data.FieldMetaData("confirmWord", org.apache.thrift.TFieldRequirementType.DEFAULT, 
    ...
    public shutdown_args(shutdown_args other) {
      if (other.isSetConfirmWord()) {
        this.confirmWord = other.confirmWord;
      }
    }
    ...
    public shutdown_args setConfirmWord(String confirmWord) {
      this.confirmWord = confirmWord;
      return this;
    }

    public void unsetConfirmWord() {
      this.confirmWord = null;
    }

    /** Returns true if field confirmWord is set (has been assigned a value) and false otherwise */
    public boolean isSetConfirmWord() {
      return this.confirmWord != null;
    }

    public void setConfirmWordIsSet(boolean value) {
      if (!value) {
        this.confirmWord = null;
      }
    }
    ...
    public boolean equals(shutdown_args that) {
      ...
      boolean this_present_confirmWord = true && this.isSetConfirmWord();
      boolean that_present_confirmWord = true && that.isSetConfirmWord();
      if (this_present_confirmWord || that_present_confirmWord) {
        if (!(this_present_confirmWord && that_present_confirmWord))
          return false;
        if (!this.confirmWord.equals(that.confirmWord))
          return false;
      }
    ...
    public int compareTo(shutdown_args other) {
      ...
      lastComparison = Boolean.valueOf(isSetConfirmWord()).compareTo(typedOther.isSetConfirmWord());
      if (lastComparison != 0) {
        return lastComparison;
      }
      if (isSetConfirmWord()) {
        lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.confirmWord, typedOther.confirmWord);
        if (lastComparison != 0) {
          return lastComparison;
        }
      }
    ...
    public String toString() {
      ...
      sb.append("confirmWord:");
      if (this.confirmWord == null) {
        sb.append("null");
      } else {
        sb.append(this.confirmWord);
      }
      first = false;
      sb.append(")");
      return sb.toString();
    ...
    private static class shutdown_argsStandardScheme extends StandardScheme<shutdown_args> {
          ...
          switch (schemeField.id) {
            case 1: // CONFIRM_WORD
              if (schemeField.type == org.apache.thrift.protocol.TType.STRING) {
                struct.confirmWord = iprot.readString();
                struct.setConfirmWordIsSet(true);
              } else { 
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, shutdown_args struct) throws org.apache.thrift.TException {
        ...
        if (struct.confirmWord != null) {
          oprot.writeFieldBegin(CONFIRM_WORD_FIELD_DESC);
          oprot.writeString(struct.confirmWord);
          oprot.writeFieldEnd();
        }
