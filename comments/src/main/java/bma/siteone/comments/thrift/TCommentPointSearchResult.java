...
public class TCommentPointSearchResult implements org.apache.thrift.TBase<TCommentPointSearchResult, TCommentPointSearchResult._Fields>, java.io.Serializable, Cloneable {
  ...
  static {
    schemes.put(StandardScheme.class, new TCommentPointSearchResultStandardSchemeFactory());
    schemes.put(TupleScheme.class, new TCommentPointSearchResultTupleSchemeFactory());
  }

  public int total; // required
  public List<TCommentPoint> result; // required
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(TCommentPointSearchResult.class, metaDataMap);
  }

  public TCommentPointSearchResult() {
  }

  public TCommentPointSearchResult(
    int total,
    List<TCommentPoint> result)
  {
    this();
    this.total = total;
    setTotalIsSet(true);
   ...
   */
  public TCommentPointSearchResult(TCommentPointSearchResult other) {
    __isset_bit_vector.clear();
    __isset_bit_vector.or(other.__isset_bit_vector);
    this.total = other.total;
    if (other.isSetResult()) {
      List<TCommentPoint> __this__result = new ArrayList<TCommentPoint>();
      for (TCommentPoint other_element : other.result) {
        __this__result.add(new TCommentPoint(other_element));
      }
...
public TCommentPointSearchResult deepCopy() {
  ...
  public TCommentPointSearchResult setTotal(int total) {
    this.total = total;
    setTotalIsSet(true);
    return this;
  }
  ...
  public java.util.Iterator<TCommentPoint> getResultIterator() {
    return (this.result == null) ? null : this.result.iterator();
  }

  public void addToResult(TCommentPoint elem) {
    if (this.result == null) {
      this.result = new ArrayList<TCommentPoint>();
    }
    this.result.add(elem);
  }

  public List<TCommentPoint> getResult() {
    return this.result;
  }

  public TCommentPointSearchResult setResult(List<TCommentPoint> result) {
    this.result = result;
    return this;
  }
...
public void setFieldValue(_Fields field, Object value) {
    ...
    case RESULT:
      if (value == null) {
        ...
        setResult((List<TCommentPoint>)value);
      }
      break;
...
public boolean isSet(_Fields field) {
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof TCommentPointSearchResult)
      return this.equals((TCommentPointSearchResult)that);
    return false;
  }

  public boolean equals(TCommentPointSearchResult that) {
    if (that == null)
      return false;
...
public void write(org.apache.thrift.protocol.TProtocol oprot) throws org.apache.thrift.TException {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("TCommentPointSearchResult(");
    boolean first = true;
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.result = new ArrayList<TCommentPoint>(_list0.size);
                for (int _i1 = 0; _i1 < _list0.size; ++_i1)
                {
                  TCommentPoint _elem2; // required
                  _elem2 = new TCommentPoint();
                  _elem2.read(iprot);
	...
	public void write(org.apache.thrift.protocol.TProtocol oprot, TCommentPointSearchResult struct) throws org.apache.thrift.TException {
      ...
      if (struct.result != null) {
        oprot.writeFieldBegin(RESULT_FIELD_DESC);
        {
          ...
          for (TCommentPoint _iter3 : struct.result)
          {
            _iter3.write(oprot);
          }
          oprot.writeListEnd();
  ...
  private static class TCommentPointSearchResultTupleScheme extends TupleScheme<TCommentPointSearchResult> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, TCommentPointSearchResult struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetResult()) {
        {
          ...
          for (TCommentPoint _iter4 : struct.result)
          {
            _iter4.write(oprot);
          }
        }
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, TCommentPointSearchResult struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.result = new ArrayList<TCommentPoint>(_list5.size);
          for (int _i6 = 0; _i6 < _list5.size; ++_i6)
          {
            TCommentPoint _elem7; // required
            _elem7 = new TCommentPoint();
            _elem7.read(iprot);
