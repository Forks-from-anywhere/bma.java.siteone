...
struct TCommentForm {
  ...
  12: optional i32 support,
  13: optional i32 oppose,
  14: optional i32 needAuth,
  15: optional i32 hideFlag,  
}
...
service TCommentsService {
   ...
   bool updateComment(1:i32 id, 2:TCommentForm info, 3:list<string> fieldNames),
