...
public class TCloudEntry implements org.apache.thrift.TBase<TCloudEntry, TCloudEntry._Fields>, java.io.Serializable, Cloneable {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("TCloudEntry");
  ...
  static {
    schemes.put(StandardScheme.class, new TCloudEntryStandardSchemeFactory());
    schemes.put(TupleScheme.class, new TCloudEntryTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(TCloudEntry.class, metaDataMap);
  }
   ...
   */
  public TCloudEntry(TCloudEntry other) {
  ...
  public TCloudEntry deepCopy() {
    return new TCloudEntry(this);
  }
  ...
  public TCloudEntry setNodeId(String nodeId) {
    this.nodeId = nodeId;
    return this;
  }
  ...
  public TCloudEntry setAppId(String appId) {
    this.appId = appId;
    return this;
  }
  ...
  public TCloudEntry setServiceId(String serviceId) {
    this.serviceId = serviceId;
    return this;
  }
  ...
  public TCloudEntry setApiId(String apiId) {
    this.apiId = apiId;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof TCloudEntry)
      return this.equals((TCloudEntry)that);
    return false;
  }

  public boolean equals(TCloudEntry that) {
    if (that == null)
      return false;
  ...
  public int compareTo(TCloudEntry other) {
    if (!getClass().equals(other.getClass())) {
      return getClass().getName().compareTo(other.getClass().getName());
    }

    int lastComparison = 0;
    TCloudEntry typedOther = (TCloudEntry)other;
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("TCloudEntry(");
    boolean first = true;
  ...
  private static class TCloudEntryStandardSchemeFactory implements SchemeFactory {
    public TCloudEntryStandardScheme getScheme() {
      return new TCloudEntryStandardScheme();
    }
  }

  private static class TCloudEntryStandardScheme extends StandardScheme<TCloudEntry> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, TCloudEntry struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TCloudEntry struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class TCloudEntryTupleSchemeFactory implements SchemeFactory {
    public TCloudEntryTupleScheme getScheme() {
      return new TCloudEntryTupleScheme();
    }
  }

  private static class TCloudEntryTupleScheme extends TupleScheme<TCloudEntry> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, TCloudEntry struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, TCloudEntry struct) throws org.apache.thrift.TException {
